    ...
    >
      ...
      >
        <div className="space-y-2" data-testid={`${source}-name-field`}>
          ...
          <Input
            ...
            className="h-12 rounded-none border-[#4a4954] bg-[#1c1b22] text-[#f1f0f4] placeholder:text-[#757480] focus-visible:ring-[#f1f0f4]"
      ...
      <div className="space-y-2" data-testid={`${source}-message-field`}>
        ...
        <Textarea
          ...
          className="min-h-32 resize-y rounded-none border-[#4a4954] bg-[#1c1b22] text-[#f1f0f4] placeholder:text-[#757480] focus-visible:ring-[#f1f0f4]"
      ...
      <div className="flex flex-col items-start gap-3 sm:flex-row sm:items-center">
        <Button
          type="submit"
          className="h-12 rounded-none border border-[#f1f0f4] bg-[#f1f0f4] px-6 font-mono text-[10px] uppercase tracking-[0.18em] text-[#100f15] transition-colors duration-200 hover:bg-transparent hover:text-[#f1f0f4] disabled:opacity-60"
